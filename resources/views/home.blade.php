    ...
    <div class="page-content">
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
            ...
            <div class="d-flex align-items-center flex-wrap text-nowrap">
                ...
                <button @click="" type="button" class="btn btn-primary btn-icon-text mb-2 mb-md-0 mx-1">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton7">
                                                        <a class="dropdown-item d-flex align-items-center"
                                                            href="javascript:;"><i data-feather="eye"
                                                                ...
                                                                class="">Xem</span></a> --}}
                                                <button type="button" class="border-0 bg-transparent" data-toggle="tooltip" data-placement="bottom" title="Hoàn thành">
